...
namespace RestSharp
{
	...
	public class RestRequest : IRestRequest
	{
        ...
        /// <summary>
        /// Serializer to use when writing encrypted JSON request bodies. Used if RequestFormat is Json.
        /// By default the included JsonSerializer is used (currently using JSON.NET default serialization).
        /// </summary>
        public ISerializer EncryptedJsonSerializer { get; set; }
		...
		public RestRequest AddBody(object obj, string xmlNamespace)
		{
			...
			switch (RequestFormat)
			{
                ...
                case DataFormat.EncryptedJson:
                    serialized = EncryptedJsonSerializer.Serialize(obj);
                    contentType = EncryptedJsonSerializer.ContentType;
                    break;
