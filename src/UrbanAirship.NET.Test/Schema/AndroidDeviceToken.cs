...
namespace UrbanAirship.NET.Test
{
    ...
    /// </summary>
    [TestClass]
    public class AndroidTestSerialization
    {
        public AndroidTestSerialization()
        {
        }
        ...
        [TestMethod]
        public void TestSchemaAndroidDeviceToken()
        {
            //
            // TODO: Add constructor logic here
            //
            var token = new AndroidDeviceTokenRegistrationInfo()
            {
                 Alias = "your_user_id",
